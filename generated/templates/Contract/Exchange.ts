...
export class Exchange__removeLiquidityResult {
  value0: BigInt;
  value1: BigInt;
...
export class Exchange extends ethereum.SmartContract {
  ...
  removeLiquidity(
    ...
    min_tokens: BigInt,
    deadline: BigInt
  ): Exchange__removeLiquidityResult {
    ...
    return new Exchange__removeLiquidityResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_removeLiquidity(
    ...
    min_tokens: BigInt,
    deadline: BigInt
  ): ethereum.CallResult<Exchange__removeLiquidityResult> {
    ...
    return ethereum.CallResult.fromValue(
      new Exchange__removeLiquidityResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
